            ...
            <div class="container">
                ...
                <div class="row my-4 box g-1" v-for="item in cartItems" :key="item.id">
                    ...
                    <div
                        ...
                        <button class="button-danger-db"
                            @click="removeItem(item.id), updateHeader()"><strong>Remove</strong>
                        </button>
                    </div>
                </div>
                ...
                <div class="my-4">
                    ...
                    <div v-else class="row">
                        <!-- BACK BUTTON -->
                        <div
                            class="col-12 col-lg-8 d-flex align-items-center justify-content-center justify-content-lg-start justify-content-xl-start">
